...
app.get('/questions', async (req, res) => {
  ...
  { question: "Which of the following is the basic structural and functional unit of life?", options: ["Tissue", "Organ", "Cell", "Organ system"], correct: "Cell" },
  { question: "Which system is responsible for transporting oxygen and nutrients throughout the body?", options: ["Digestive system", "Nervous system", "Circulatory system", "Respiratory system"], correct: "Circulatory system" },
  { question: "The process by which the body maintains a stable internal environment is known as:", options: ["Metabolism", "Homeostasis", "Respiration", "Circulation"], correct: "Homeostasis" },
  { question: "Which organ is primarily responsible for filtering blood and producing urine?", options: ["Liver", "Kidney", "Pancreas", "Spleen"], correct: "Kidney" },
  { question: "The largest organ in the human body is the:", options: ["Brain", "Heart", "Liver", "Skin"], correct: "Skin" },
  { question: "The heart has four chambers: two atria and two ventricles.", options: ["True", "False"], correct: "True" },
  { question: "The trachea is part of the digestive system.", options: ["True", "False"], correct: "False" },
  ...
  "Principles of Pharmacy Technician Practice": [
    ...
    },
    {
      ...
      correct: "Pharmacy Council of Nigeria",
    },
    {
